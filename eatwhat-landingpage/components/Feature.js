...
const features = [
  "Compare prices across Woolworths, Coles & ALDI",
  "Smart meal suggestions based on sales & specials",
  "Automatic shopping list generation",
  "Track your grocery spending & save money"
]
      ...
      <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-2 gap-8 p  y-8 my-12">
        ...
        <motion.div className="flex flex-col items-end justify-center ml-auto w-full lg:w-9/12" variants={scrollAnimation}>
          ...
          <p className="my-2 text-black-500">
            EatWhat makes it easy to plan delicious meals while saving money on groceries.
